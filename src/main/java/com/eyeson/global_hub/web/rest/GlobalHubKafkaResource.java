...
@RestController
@RequestMapping("/api/global-hub-kafka")
public class GlobalHubKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GlobalHubKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GlobalHubKafkaResource(KafkaProperties kafkaProperties) {
