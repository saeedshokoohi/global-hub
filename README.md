...
To build the final jar and optimize the GlobalHub application for production, run:
...
Then navigate to [http://localhost:6063](http://localhost:6063) in your browser.
